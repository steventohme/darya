...
pub fn file_icon(filename: &str, is_dir: bool) -> FileIcon {
    ...
    match lower.as_str() {
        "dockerfile" | "dockerfile.dev" | "dockerfile.prod" => {
            return FileIcon {
                icon: '\u{e7b0}',
                color: Color::Rgb(0x23, 0x96, 0xED),
            };
        }
    ...
    match ext {
        ...
        "js" => FileIcon {
            icon: '\u{e74e}',
            color: Color::Rgb(0xF7, 0xDF, 0x1E),
        },
        "sql" => FileIcon {
            icon: '\u{e706}',
            color: Color::Rgb(0xE4, 0x8E, 0x00),
        },
        "graphql" | "gql" => FileIcon {
            icon: '\u{e662}',
            color: Color::Rgb(0xE1, 0x35, 0xAB),
        },
        "md" => FileIcon {
            icon: '\u{e73e}',
        ...
        "json" => FileIcon {
            icon: '\u{e60b}',
            color: Color::Rgb(0xCB, 0xCB, 0x41),
        },
        "yaml" | "yml" => FileIcon {
            icon: '\u{e6a8}',
        ...
        "toml" => FileIcon {
            icon: '\u{f0ad}',
            color: Color::Rgb(0x9C, 0x40, 0x36),
        },
        "html" => FileIcon {
            icon: '\u{e736}',
